...
type Node struct {
	ChildOfRootProperty
	Camera      *Id         `json:"camera,omitempty"`      //The index of the camera referenced by this node.
	Children    []Id        `json:"children,omitempty"`    //The indices of this node's children.
	Skin        *Id         `json:"skin,omitempty"`        //The index of the skin referenced by this node. When a skin is referenced by a node within a scene, all joints used by the skin **MUST** belong to the same scene. When defined, `mesh` **MUST** also be defined.
	Matrix      [16]float64 `json:"matrix,omitempty"`      //A floating-point 4x4 transformation matrix stored in column-major order.
	Mesh        *Id         `json:"mesh,omitempty"`        //The index of the mesh in this node.
